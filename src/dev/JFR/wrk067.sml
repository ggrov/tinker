...
val (unary_v, unary_p) = dest_pair ¨(x, x ç (¡, ¬) Continuous)Æ;
val (binary_v, binary_p) = dest_pair ¨(x, Uncurry x ç (¡, ¬) Continuous)Æ;
val (parametrized_v, parametrized_p) = dest_pair ¨(h, (Ã x∑ h x p) ç (¡, ¬) Continuous)Æ;
val (object_v, object_p) = dest_pair ¨(¡, ¡ ç Topology)Æ;
...
val fst_const : TERM = ¨FstÆ;
val snd_const : TERM = ¨SndÆ;
