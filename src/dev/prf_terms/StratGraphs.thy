...
ML{*
  ...
  val gt_imp_e = "top_symbol(HOL.impE)";
...
(* psgraph: imp I/E and asm *)
  ...
  val psimpE2 = PSComb.LIFT ([gt_imp_e],[gt,gt]) (impE);
  val psasm = PSComb.LIFT ([gt],[]) (asm);
  val psasm2 = PSComb.LIFT ([gt,gt],[]) (asm);
  val psf = psimpI1 THENG psimpI1 THENG psimpE1 THENG 
                psasm (*THENG psimpE1 THENG psasm THENG psimpE2 THENG psasm2*);
...
(* psgraph: graph containing impI, notI/E, asm*)
  ...
  val psnotI = PSComb.LIFT ([gt_not],[gt_not,gt]) (notI)
  val psnotE = PSComb.LIFT ([gt_not],[gt]) (notE)
  val psasm1 = PSComb.LIFT ([gt],[]) (asm);
